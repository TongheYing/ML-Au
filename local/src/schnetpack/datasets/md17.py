...
class MD17(DownloadableAtomsData):
    ...
    Args:
        ...
        molecule (str): Name of molecule to load into database. Allowed are:
                            ...
                            toluene
                            uracil
        subset (list): indices of subset. Set to None for entire dataset  可以只下载一部分数据集
            (default: None)
        ...
        load_only (list, optional): reduced set of properties to be loaded  只下载一部分性质
    ...
    energy = "energy"  # 在此定义就可以直接调用MD17.energy变量
    forces = "forces"
    ...
    def __init__(
        ...
        self.molecule = molecule  # 下载了ethanol
